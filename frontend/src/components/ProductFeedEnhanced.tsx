    ...
    <div className={cn(
      ...
      {isHighPriority && (
        <div className="absolute top-3 right-3 z-10">
          <div className="flex items-center gap-1 px-2 py-1 bg-green-500 text-white text-xs font-bold rounded-full shadow-lg shadow-green-500/50">
      ...
      <div className="relative p-4">
        ...
        <div className="flex items-start gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1 flex-wrap">
              ...
              <span className="px-2 py-0.5 text-xs bg-[#1a1a24] text-gray-400 rounded">
                {event.source}
              </span>
            </div>
            <h3 className="text-sm font-semibold text-white line-clamp-2 mb-1">{event.product}</h3>
        ...
        {event.matched && (
          <div className="mb-3 p-2 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-gray-500">{Math.round(event.confidence * 100)}% match</span>
            </div>
          </div>
        )}
          ...
          <div className="mb-3">
            ...
            <div className="flex flex-wrap gap-1">
              ...
              {event.sizes.length > 8 && (
                <span className="px-2 py-1 text-xs bg-[#1a1a24] text-gray-500 rounded">
                  +{event.sizes.length - 8}
                </span>
              )}
            </div>
        ...
        <div className="flex gap-2">
          ...
          <a
            ...
            className="px-4 py-2 rounded-lg bg-[#1a1a24] text-gray-400 hover:text-white hover:bg-[#2a2a3a] transition-colors flex items-center justify-center"
          >
  ...
  return (
    <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2 bg-[#1a1a24] border border-[#2a2a3a] rounded-lg text-white focus:outline-none focus:border-purple-500"
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="p-4 rounded-xl bg-[#0f0f18] border border-[#1a1a2e]">
          <p className="text-sm text-gray-500 mb-1">Avg Profit</p>
        ...
        <div className="p-4 rounded-xl bg-[#0f0f18] border border-[#1a1a2e]">
          <p className="text-sm text-gray-500 mb-1">Stores Active</p>
