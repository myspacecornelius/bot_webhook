...
export function Sidebar() {
  ...
  const { data: monitorStatus, lastUpdated: monitorLastUpdated } =
  ...
  return (
    <aside className="w-[280px] h-screen flex flex-col bg-[var(--surface)] border-r border-[var(--border)]">
      {/* Logo */}
      <div className="p-6 border-b border-[var(--border)]">
        <div className="flex items-center gap-4">
          <div className="relative">
            <div
              className="w-12 h-12 rounded-xl bg-[var(--gradient-primary)] flex items-center justify-center shadow-lg"
            ...
            <div
              className={cn(
                "absolute -top-0.5 -right-0.5 w-3.5 h-3.5 rounded-full border-2 border-[var(--surface)]",
                isConnected
                  ? "bg-emerald-400"
                  : engineDegraded
                    ? "bg-amber-400"
      ...
      <nav className="flex-1 px-4 py-3 space-y-1 overflow-y-auto">
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <Icon
                className={cn("w-5 h-5", isActive && "text-[var(--primary)]")}
              />
      ...
      <div className="p-4 border-t border-[var(--border)]">
        <div
          className="p-4 rounded-xl border border-[var(--primary)]/30"
          style={{
            background:
              "linear-gradient(to right, hsl(var(--accent-hue) 42% 48% / 0.12), hsl(var(--accent-hue) 50% 38% / 0.12))",
          }}
        >
          <div className="flex items-center gap-2.5">
