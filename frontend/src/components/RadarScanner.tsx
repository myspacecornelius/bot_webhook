  ...
  return (
    <div className="flex flex-col items-center justify-center py-20">
      ...
      <div className="relative w-32 h-32 mb-6">
        ...
        <div className="absolute inset-2 rounded-full border-2 border-[var(--info)]/30 animate-ping" style={{ animationDelay: '0.5s' }} />
        <div className="absolute inset-4 rounded-full border-2 border-[var(--info)]/30 animate-ping" style={{ animationDelay: '1s' }} />
      ...
      <div className="text-center">
        ...
        <p className="text-[var(--muted)] mb-4">Monitoring stores for products...</p>
