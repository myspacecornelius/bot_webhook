    ...
    <div className={cn(
      ...
      {isHighPriority && (
        <div className="absolute top-3 right-3 z-10">
          <div className="flex items-center gap-1 px-2 py-1 bg-green-500 text-white text-xs font-bold rounded-full animate-pulse-glow">
      ...
      <div className="relative p-4">
        ...
        <div className="flex items-start gap-3 mb-3">
          ...
          <div className="w-16 h-16 rounded-lg bg-[#1a1a24] flex items-center justify-center overflow-hidden">
            {event.imageUrl ? (
          ...
          <div className="flex-1 min-w-0">
            ...
            <h3 className="text-sm font-semibold text-white truncate">{event.product}</h3>
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-1">
            {event.sizes.slice(0, 8).map((size, i) => (
              <span 
                key={i}
                className="px-2 py-1 text-xs bg-[#1a1a24] text-gray-300 rounded border border-[#2a2a3a]"
              >
                {size}
              </span>
            ))}
        ...
        <div className="flex gap-2">
          ...
          <a
            ...
            className="flex items-center justify-center px-3 py-2 bg-[#1a1a24] hover:bg-[#252532] text-gray-300 rounded-lg transition-colors border border-[#2a2a3a]"
          >
